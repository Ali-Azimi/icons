...
const ExpandCardOnLgSVG = ({ title, titleId, color = '#9E9E9E', ...props }) => (
    <svg xmlns='http://www.w3.org/2000/svg' width={32} height={32} fill='none' viewBox='0 0 32 32' aria-labelledby={titleId} {...props}>
        ...
        <path
            fill={color}
            fillRule='evenodd'
            d='M20.707 14.293a1 1 0 0 1 0 1.414l-4 4a1 1 0 0 1-1.414 0l-4-4a1 1 0 0 1 1.414-1.414L16 17.586l3.293-3.293a1 1 0 0 1 1.414 0Z'
            clipRule='evenodd'
        />
    </svg>
);
export default ExpandCardOnLgSVG;
